...
## [1.1.0](https://github.com/LerianStudio/console-sdk/releases/tag/sindarian-i18n-cli-v1.1.0)

Changelog for sindarian-i18n-cli:
...
Fixes:
- Reject locale entries whose value is not a string.
- Reject a locale file that is not a JSON object.
- Keep locale ids that collide with Object.prototype.
- Sort non-default locale files.

Improvements:
- Remove redundant shebang from CLI source.
- Format tsup config.

Contributors: @fred, @gabrielcastro.xy

[Compare changes](https://github.com/LerianStudio/console-sdk/compare/sindarian-i18n-cli-v1.0.1...sindarian-i18n-cli-v1.1.0)

---

## [1.1.0](https://github.com/LerianStudio/console-sdk/compare/sindarian-i18n-cli-v1.0.1...sindarian-i18n-cli-v1.1.0) (2026-08-26)
...
## [1.1.0-beta.1](https://github.com/LerianStudio/console-sdk/compare/sindarian-i18n-cli-v1.0.1...sindarian-i18n-cli-v1.1.0-beta.1) (2026-08-26)
