...
- **Features:**
  - Migrated sindarian-logs to TypeScript 6.

- **Fixes:**
  - Redacted PII in README example and cleaned up the changelog.
  - Used a non-PII identifier in the README log example.
...
## [1.1.0-beta.3](https://github.com/LerianStudio/console-sdk/compare/sindarian-logs-v1.1.0-beta.2...sindarian-logs-v1.1.0-beta.3) (2026-07-16)
...
## [1.1.0-beta.2](https://github.com/LerianStudio/console-sdk/compare/sindarian-logs-v1.1.0-beta.1...sindarian-logs-v1.1.0-beta.2) (2026-07-03)
