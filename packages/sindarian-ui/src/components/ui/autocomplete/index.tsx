...
export function AutocompleteValue({
  ...
  return (
    <CommandPrimitive.Input
      ...
      readOnly={readOnly}
      className={cn(
        'placeholder:text-muted-foreground outline-hidden focus:outline-hidden w-full bg-transparent read-only:opacity-50 read-only:placeholder:opacity-0 disabled:cursor-not-allowed disabled:opacity-50 disabled:placeholder:opacity-0',
        className
      )}
      onBlur={handleBlur}
    />
  ...
  return (
    <>
      ...
      <CommandPrimitive.Input
        ...
        disabled={disabled}
        className={cn(
          'placeholder:text-muted-foreground outline-hidden focus:outline-hidden w-full bg-transparent disabled:cursor-not-allowed disabled:opacity-50 disabled:placeholder:opacity-0',
          className
        )}
      />
    </>
