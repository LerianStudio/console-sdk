...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'focus:bg-shadcn-100 focus:text-accent-foreground text-muted-foreground outline-hidden data-disabled:pointer-events-none data-disabled:opacity-50 relative flex cursor-pointer select-none items-center gap-3 px-3 py-2 text-sm font-medium transition-colors',
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-shadcn-100 data-[state=open]:bg-accent text-muted-foreground outline-hidden flex cursor-default select-none items-center gap-3 px-3 py-2 text-sm font-medium',
        className
      )}
      {...props}
    >
