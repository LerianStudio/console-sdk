  ...
  return (
    <>
      ...
      <CommandPrimitive.Input
        ...
        disabled={disabled}
        className={cn(
          'placeholder:text-input-placeholder bg-transparent outline-hidden focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 disabled:placeholder:opacity-0',
          className
        )}
      />
    </>
